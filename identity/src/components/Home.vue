            ...
            <div class="section-content">
                <div class="section-list">
                    ...
                    <div class="section-tab">
                        <div class="section-text"><span>姓</span>名</div>
                        <div class="section-input"><input v-model="user.name" placeholder="请输入您的姓名"
                                                          class="section-input-text"/></div>
                    </div>
                    <div class="section-tab">
                        <div class="section-text"><span>民</span>族</div>
                        <div class="section-input"><input v-model="user.nation" placeholder="请输入您的所属民族"
                                                          class="section-input-text"/></div>
                    </div>
                    <div class="section-tab">
                        <div class="section-text">身份证号</div>
                        <div class="section-input"><input v-model="user.number" placeholder="请输入您的身份证号"
                                                          class="section-input-text"/></div>
                    </div>
                    <div class="section-tab">
                        <div class="section-text"><span>地</span>址</div>
                        <div class="section-input"><textarea v-model="user.address"
                                                             placeholder="具体到门牌号 例如XX省XX市XX区XX街道XX小区XX楼"
                                                             class="section-input-address"/></div>
                    </div>
                    <div>
                        <button v-on:click="register" class="section-btn-apply">登录</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            async register() {
                ...
                let data = contract.methods.register(this.user.number, this.user.nation, this.user.name, this.user.address).encodeABI()
                const tx = {
                    data,
                ...
                // const tx = {
                //     from: this.account.address,
                //     to: '0x9F815B3c0bD46454cE8444704c16fc5a8a1c3b71',
                //     gas: 200000,
                //     gasPrice: 1000000,
